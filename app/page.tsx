        ...
        <div className="grid gap-8 md:grid-cols-2 md:items-center">
          <div>
            <p className="inline-flex items-center rounded-full bg-slate-100 px-3 py-1 text-sm font-medium text-slate-700">
              💧 Loja especializada em irrigacao • Atendimento tecnico
            </p>

            <h1 className="mt-4 text-3xl font-semibold tracking-tight md:text-5xl">
              Irrigacao eficiente, com suporte de quem entende.
            </h1>

            <p className="mt-4 text-base leading-relaxed text-slate-600 md:text-lg">
              Produtos selecionados, orientacao tecnica e solucoes praticas para jardim, gramado,
              paisagismo e pequenas areas agricolas. Mais economia de agua, mais resultado.
            </p>
            ...
            <div className="mt-6 flex flex-col gap-3 sm:flex-row">
              ...
              >
                Pedir orientacao tecnica
              </a>
            </div>

            <div className="mt-6 text-sm text-slate-500">
              Atendimento humanizado • Conteudo tecnico • Compra segura
            </div>
          </div>
          ...
          <div className="rounded-2xl border border-slate-200 bg-gradient-to-b from-slate-50 to-white p-6 shadow-sm">
            <div className="grid gap-4">
              <div className="rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-100">
                <div className="text-sm font-semibold text-slate-900">Diagnostico rapido</div>
                <div className="mt-1 text-sm text-slate-600">
                  Informe area, pressao e objetivo. A gente indica o melhor caminho.
                </div>
              </div>
              <div className="rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-100">
                <div className="text-sm font-semibold text-slate-900">Produtos por aplicacao</div>
                <div className="mt-1 text-sm text-slate-600">
                  Aspersao, gotejamento e linha hidraulica com foco em desempenho.
                </div>
              </div>
              <div className="rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-100">
                <div className="text-sm font-semibold text-slate-900">Entrega e suporte</div>
                <div className="mt-1 text-sm text-slate-600">
                  Conteudo e suporte tecnico para instalacao e regulagem.
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-10">
        <div className="flex items-end justify-between gap-4">
          <div>
            ...
            <p className="mt-2 text-slate-600">
              Seleçao com boa saida e aplicacao pratica.
            </p>
          </div>
          ...
          <div className="grid gap-8 md:grid-cols-2 md:items-center">
            <div>
              <h2 className="text-2xl font-semibold tracking-tight md:text-3xl">
                Quer acertar na irrigacao e evitar retrabalho?
              </h2>
              <p className="mt-3 text-white/80">
                Fale com a Casa da Irrigacao e receba orientacao tecnica para escolher
                produtos e montar um sistema eficiente (sem comprar errado).
              </p>
              <ul className="mt-5 space-y-2 text-sm text-white/90">
                <li>✅ Indicacao de produto por aplicacao</li>
                <li>✅ Dicas de pressao, vazao e regulagem</li>
                <li>✅ Solucao para jardim, gramado e pequenas areas</li>
              </ul>
            </div>
            ...
            <div className="rounded-2xl bg-white/5 p-5 ring-1 ring-white/10">
              <form className="grid gap-3">
                ...
                <label className="text-sm font-semibold">O que voce quer irrigar?</label>
                <input
                  className="rounded-xl bg-white/10 px-4 py-3 text-sm outline-none ring-1 ring-white/10 placeholder:text-white/50 focus:ring-2 focus:ring-white/30"
                ...
                <p className="text-xs text-white/70">
                  * Ajuste o numero do WhatsApp no link (wa.me).
                </p>
              </form>
            </div>
          </div>
